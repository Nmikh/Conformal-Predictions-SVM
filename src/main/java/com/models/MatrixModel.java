...
public class MatrixModel {
    private int truePositive; //Old: 2-2; New: 1 -> 1
    private int falseNegative; //Old: 2-4; New: 1 -> -1
    private int trueNegative; //Old: 4-4; New: -1 -> -1
    private int falsePositive; //Old: 4-2; New: -1 -> 1
